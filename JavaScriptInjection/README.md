...
Download zip file and extract it [latest release](https://github.com/reysmerwvr/UIKit-Series/JavaScriptInjection). Or clone the repository and open it using Xcode.
